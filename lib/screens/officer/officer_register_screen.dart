...
class OfficerRegisterScreen extends StatefulWidget {
  ...
  @override
  State<OfficerRegisterScreen> createState() =>
...
class _OfficerRegisterScreenState extends State<OfficerRegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    final result = await AuthService.registerOfficer(
      nameController.text.trim(),
      emailController.text.trim(),
      passwordController.text.trim(),
      phoneController.text.trim(),
      departmentIdController.text.trim().toUpperCase(),
    );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Register with your Department ID to access the officer portal",
            ...
            Padding(
              ...
              child: Text(
                "Contact your department administrator for the Department ID",
                style: TextStyle(
